  ...
  return (
    <div>
      ...
      <div className="justify-center items-center">
        <ul >
          <li className="flex flex-row  justify-center  space-x-24 bg-[#fbebb5]">
            <h2>product</h2>
            <h2>price</h2>
            <h2>quantity</h2>
            <h2>subTotal</h2>
        ...
        <div className="mt-11 sm:max-w-4xl sm:mx-auto  flex flex-row  ">
          {cart.length === 0 ? (
            ...
            <ul className="space-y-4 space-x-0 ">
              {cart.map((product) => (
                <li key={product.id} className="flex flex-row ">
                  <span className="flex flex-col justify-center items-center mx-11 sm:mx-20">
                    <Image
